...
import com.pro4j.promise.AbortController
import com.pro4j.promise.AbortException
...
import com.tencent.wxpfc.TestUtil.*
...
//        }
    ...
    fun `promise repeat test2` () {
        val rands = getRandomNums(10,100, 1000, 100, true)
        var attempt = 0;
